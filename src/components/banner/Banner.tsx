...
export default function Banner() {
    ...
    return (
        <>
            <section className="p-5 container mx-auto py-5 lg:py-10 flex flex-col lg:flex-row justify-between  gap-5 mt-30 lg:mt-20">
                <div className="flex-1 flex flex-col justify-center gap-8">
                    <div className="flex flex-col gap-5">
                        <h1 className="text-gray-800 text-center lg:text-start text-3xl lg:text-7xl font-extrabold">Build Your Ideal<br />
                        ...
                        <p className="text-center lg:text-start text-[18px] lg:text-[25px] text-gray-500">Explore frontend, backend, database, and tooling options,
