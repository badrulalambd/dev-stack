                ...
                <section className="p-5 container mx-auto py-10 flex flex-col lg:flex-row justify-between  gap-0 lg:gap-5 mt-30 lg:mt-20">
                    <div className="flex-1 flex flex-col justify-center gap-8">
                        ...
                        <div className="flex flex-wrap justify-center lg:justify-start gap-3 mt-3">
                            <button
                                className="btn border-0 bg-linear-to-r from-[#F97316] to-[#EC4899] px-7 py-3 text-white font-semibold rounded-xl shadow-md shadow-pink-200/40 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-pink-200/50"
                            >
